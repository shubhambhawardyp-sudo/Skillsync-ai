...
import {
  ...
  useLayoutEffect2
} from "./chunk-RKIBK2FF.js";
import {
  Primitive,
  createContextScope,
  createSlot,
  useComposedRefs
} from "./chunk-N5R6SLCS.js";
import {
  require_react_dom
...
function SelectProvider(props) {
  ...
  const initialValueRef = React14.useRef(value);
  React14.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name2(() => setValue(initialValueRef.current), "reset");
  ...
  const handleNativeOptionAdd = React14.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React14.useCallback((option) => {
  ...
  return (0, import_jsx_runtime3.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime3.jsx)(SelectProviderImpl, { scope: __scopeSelect, ...context, children: (0, import_jsx_runtime3.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime3.jsx)(
...
__name2(SelectProvider, "SelectProvider");
var Select = __name2((props) => {
...
var SelectTrigger = React14.forwardRef(
  __name2(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name2((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React14.forwardRef(
  __name2(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime3.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime3.jsx)(React14.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React14.forwardRef(
  __name2(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name2((props) => {
  const { __scopeSelect, forceMount, ...portalProps } = props;
  return (0, import_jsx_runtime3.jsx)(PortalProvider, { scope: props.__scopeSelect, forceMount, children: (0, import_jsx_runtime3.jsx)(Portal, { asChild: true, ...portalProps }) });
}, "SelectPortal");
var CONTENT_NAME = "SelectContent";
var SelectContent = React14.forwardRef(
  __name2(function SelectContent2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime3.jsx)(Presence, { present: forceMount || context.open, children: ({ present }) => present ? (0, import_jsx_runtime3.jsx)(SelectContentImpl, { ...contentProps, ref: forwardedRef }) : (0, import_jsx_runtime3.jsx)(SelectContentFragment, { ...contentProps, fragment }) });
  }, "SelectContent")
);
var SelectContentFragment = React14.forwardRef(__name2(function SelectContentFragment2(props, forwardedRef) {
  const { __scopeSelect, children, fragment } = props;
  if (!fragment) return null;
  return ReactDOM.createPortal(
    (0, import_jsx_runtime3.jsx)(SelectContentProvider, { scope: __scopeSelect, children: (0, import_jsx_runtime3.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime3.jsx)("div", { ref: forwardedRef, children }) }) }),
    fragment
  );
...
var SelectContentImpl = React14.forwardRef(
  ...
  __name2(function SelectContentImpl2(props, forwardedRef) {
    ...
    React14.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name2((event) => {
          var _a, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name2((event) => {
    ...
    React14.useEffect(() => {
      const close = __name2(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React14.forwardRef(__name2(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React14.forwardRef(__name2(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React14.forwardRef(
  __name2(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React14.forwardRef(
  __name2(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React14.forwardRef(
  __name2(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React14.forwardRef(
  __name2(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React14.forwardRef(
  __name2(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React14.forwardRef(
  // blank line to reduce diff noise
  __name2(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React14.forwardRef(__name2(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name2(handleScroll22, "handleScroll");
...
var SelectScrollDownButton = React14.forwardRef(__name2(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React14.forwardRef(__name2(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React14.forwardRef(
  // blank line to reduce diff noise
  __name2(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React14.forwardRef(
  __name2(function SelectArrow2(props, forwardedRef) {
    const { __scopeSelect, ...arrowProps } = props;
    const popperScope = usePopperScope(__scopeSelect);
    const contentContext = useSelectContentContext(ARROW_NAME, __scopeSelect);
    return contentContext.position === "popper" ? (0, import_jsx_runtime3.jsx)(Arrow, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }, "SelectArrow")
);
var BUBBLE_INPUT_NAME = "SelectBubbleInput";
var SelectBubbleInput = React14.forwardRef(
  // blank line to reduce diff noise
  __name2(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
    ...
    return (0, import_jsx_runtime3.jsxs)(
      Primitive.select,
      {
        ...
        children: [
          shouldShowPlaceholder(value) && !hasEmptyValueOption ? (0, import_jsx_runtime3.jsx)("option", { value: "" }) : null,
...
__name2(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React14.useCallback(
    (key) => {
      ...
      __name2(function updateSearch(value) {
...
__name2(useTypeaheadSearch, "useTypeaheadSearch");
...
__name2(findNextItem, "findNextItem");
