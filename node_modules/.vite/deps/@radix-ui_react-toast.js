...
var ToastProvider = __name((props) => {
  const {
    __scopeToast,
    label = "Notification",
    duration = 5e3,
...
var ToastViewport = React.forwardRef(
  __name(function ToastViewport2(props, forwardedRef) {
    const {
      __scopeToast,
    ...
    React.useEffect(() => {
      ...
      if (hasToasts && wrapper && viewport) {
        ...
        const handleFocusOutResume = __name((event) => {
          const isFocusMovingOutside = !wrapper.contains(event.relatedTarget);
          if (isFocusMovingOutside) handleResume();
        }, "handleFocusOutResume");
        const handlePointerLeaveResume = __name(() => {
...
var FocusProxy = React.forwardRef(
  ...
  __name(function ToastFocusProxy(props, forwardedRef) {
...
var Toast = React.forwardRef(
  // blank line to reduce diff noise
  __name(function Toast2(props, forwardedRef) {
...
var ToastImpl = React.forwardRef(
  __name(function ToastImpl2(props, forwardedRef) {
    const {
      __scopeToast,
      type = "foreground",
          ...
          Root,
          {
            ...
            onEscapeKeyDown: composeEventHandlers(onEscapeKeyDown, (event) => {
              const isFocusInToast = getItems().some(
                (item) => {
                  var _a;
                  return (_a = item.ref.current) == null ? void 0 : _a.contains(event.target);
                }
              );
              if (!isFocusInToast) {
                handleClose();
...
var ToastAnnounce = __name((props) => {
...
var ToastTitle = React.forwardRef(
  __name(function ToastTitle2(props, forwardedRef) {
...
var ToastDescription = React.forwardRef(
  // blank line to reduce diff noise
  __name(function ToastDescription2(props, forwardedRef) {
...
var ToastAction = React.forwardRef(
  __name(function ToastAction2(props, forwardedRef) {
...
var ToastClose = React.forwardRef(
  __name(function ToastClose2(props, forwardedRef) {
...
var ToastAnnounceExclude = React.forwardRef(__name(function ToastAnnounceExclude2(props, forwardedRef) {
...
var isDeltaInDirection = __name((delta, direction, threshold = 0) => {
